...
<body>
    ...
    <div class="container">
        <div class="row">
            <div class="col-4 text-center product-container">
                ...
                <label for="product1" id="price1" class="price-label">350.00</label>
            ...
            <div class="col-4 text-center product-container">
                ...
                <label for="product2" id="price2" class="price-label">370.00</label>
            ...
            <div class="col-4 text-center product-container">
                ...
                <label for="product3" id="price3" class="price-label">550.00</label>
            ...
            <div class="col-4 text-center product-container">
                ...
                <label for="product4" id="price4" class="price-label">550.00</label>
            ...
            <div class="col-4 text-center product-container">
                ...
                <label for="product5" id="price5" class="price-label">400.00</label>
            ...
            <div class="col-4 text-center product-container">
                ...
                <label for="product6" id="price6" class="price-label">980.00</label>
                <input type="number" class="form-control" id="qty6" placeholder="Enter quantity" /><br>
            </div>
            <div class="col-4 orders-container">
